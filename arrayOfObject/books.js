...
//language count or language summary
...
//most books language
var most = Object.entries(languageCount).reduce((b1,b2)=>b1[1]>b2[1]?b1:b2)
console.log(most);

//least books language
var least= Object.entries(languageCount).reduce((b1,b2)=>b1[1]<b2[1]?b1:b2)
console.log(least);
